...
var _peopleJson = require("./lib/people.json");
var _peopleJsonDefault = parcelHelpers.interopDefault(_peopleJson);
'use strict';
const formattedPeople = (0, _peopleJsonDefault.default).map((person)=>{
    const age = person.died - person.born;
    const century = Math.ceil(person.died / 100);
    let gender = person.sex;
    if (person.sex === 'm') gender = 'Male';
    else if (person.sex === 'f') gender = 'Female';
    return {
        ...person,
        age,
        century,
...
},{}]},["15Ryi","3Aj1C"], "3Aj1C", "parcelRequireee03", {})

//# sourceMappingURL=js_task_generate_table_DOM.4841ef46.js.map
